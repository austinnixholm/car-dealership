# car-dealership
This website is intended to function as a car dealership, with the ability for staff members to complete various functions for the site to work as expected.
...
<b>To run this application, you must create a local SQL database called 'Dealership'.</b>

To set up: 

1. Navigate to /DealerShipAPI/sql queries/
2. Execute Create.sql, Sprocs.sql, DBReset.sql, and Values.sql in your SQL Studio.
